...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        final boolean propertyNonEmpty = Pattern.matches(".+", str);

        final boolean propertyLowerCase = Pattern.matches(".*[a-z]+.*", str);
        final boolean propertyUpperCase = Pattern.matches(".*[A-Z]+.*", str);
        final boolean propertyDigit = Pattern.matches(".*\\d+.*", str);
        final boolean propertyMinLength = str.length() >= minLength;

        // as needed, modify this code.
        return propertyNonEmpty && propertyLowerCase && propertyUpperCase && propertyDigit && propertyMinLength;
    }
